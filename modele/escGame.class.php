...
class EscGame extends database {
  ...
  *******************************************************/
  ...
  public function modif_game($genre, $duree, $lieu, $categorie, $nbjoueur, $environnement, $environnementeng, $nom, $nomeng, $description, $descriptioneng, $prix, $parcours, $nbenigme, $latitude, $longitude, $prix_3, $prix_4, $prix_5, $prix_6, $prix_7, $prix_8, $prix_9, $prix_10, $prix_11, $prix_12, $prix_groupe, $id_game ){
    $req='UPDATE game SET game_genre=?, game_duree=?, game_lieu=?, game_categorie=?, game_nbjoueur=?, game_environnement=?, game_environnementeng=?, game_nom=?, game_nomeng=?, game_description=?, game_decriptioneng=?, game_prix=?, game_parcours=?, game_nbenigme=?, game_latitude=?, game_longitude=?, game_prix_3=?, game_prix_4=?, game_prix_5=?, game_prix_6=?, game_prix_7=?, game_prix_8=?, game_prix_9=?, game_prix_10=?, game_prix_11=?, game_prix_12=?, game_prix_groupe=? where game_id=?;';
    $rep=$this->execReqPrep($req, array($genre, (int)$duree, $lieu, $categorie, (int)$nbjoueur, $environnement, $environnementeng, $nom, $nomeng, $description, $descriptioneng, (float)$prix, (float)$parcours, (int)$nbenigme, $latitude, $longitude, (float)$prix_3, (float)$prix_4, (float)$prix_5, (float)$prix_6, (float)$prix_7,(float)$prix_8, (float)$prix_9, (float)$prix_10, (float)$prix_11, (float)$prix_12, (float)$prix_groupe, $id_game));
    return $rep;
  }

  public function enreg_game($genre, $duree, $lieu, $categorie, $nbjoueur, $environnement, $environnementeng, $nom, $nomeng, $description, $descriptioneng, $prix, $parcours, $nbenigme, $latitude, $longitude, $prix_3, $prix_4, $prix_5, $prix_6, $prix_7, $prix_8, $prix_9, $prix_10, $prix_11, $prix_12, $prix_groupe){
    $req='INSERT INTO `game`(`game_genre`, `game_duree`, `game_lieu`, `game_categorie`, `game_nbjoueur`, `game_environnement`, `game_environnementeng`, `game_nom`, `game_nomeng`, `game_description`, `game_decriptioneng`, `game_prix`, `game_parcours`, `game_nbenigme`, `game_latitude`, `game_longitude`, `game_prix_3`, `game_prix_4`, `game_prix_5`, `game_prix_6`, `game_prix_7`, `game_prix_8`, `game_prix_9`, `game_prix_10`, `game_prix_11`, `game_prix_12`, `game_prix_groupe`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);';
    $rep=$this->execReqPrep($req, array($genre, (int)$duree, $lieu, $categorie, (int)$nbjoueur, $environnement, $environnementeng, $nom, $nomeng, $description, $descriptioneng, (float)$prix, (float)$parcours, (int)$nbenigme, $latitude, $longitude, (float)$prix_3, (float)$prix_4, (float)$prix_5, (float)$prix_6, (float)$prix_7,(float)$prix_8, (float)$prix_9, (float)$prix_10, (float)$prix_11, (float)$prix_12, (float)$prix_groupe));
    return $rep;
  }

  public function delete_game($id_game){
    $req= 'DELETE from game where game_id=?;';
    $result=$this->execReqPrep($req, array($id_game));
    return $result;
  }
 }
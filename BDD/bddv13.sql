...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 13 avr. 2023 à 08:59
...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  `resa_date_transaction` varchar(20) NOT NULL,
  `resa_prix` varchar(10) NOT NULL,
  PRIMARY KEY (`resa_id`)
...
INSERT INTO `booking` (`resa_id`, `resa_horaire`, `id_user`, `resa_idgame`, `resa_nbpersonne`, `resa_date`, `resa_date_transaction`, `resa_prix`) VALUES
(1, 0x3133, 1, 1, 5, '04/04/2023', '1681368720', '114');
